...
export const ProductCardContainer = styled.article`
  ...
  h3 {
    margin: 0;
    color: ${({ $isDark }) => ($isDark ? theme.colors.white : theme.colors.textSecondary)};
  ...
  h3 span {
    color: ${({ $isDark }) => ($isDark ? theme.colors.white : theme.colors.textPrimary)};
  }
  ...
  .product-card__button {
    ...
    background-color: ${({ $isDark }) => ($isDark ? '#D9D9D9' : theme.colors.primary)};
    color: ${({ $isDark }) => ($isDark ? theme.colors.textPrimary : theme.colors.white)};
    font-size: ${theme.fontSize.label.size};
    text-align: center;
  ...
  .product-card__button:hover {
    background-color: ${({ $isDark }) => ($isDark ? '#C8C9C9' : theme.colors.hover)};
  }
`;
