...
export const ProductCardContainer = styled.article`
  ...
  .product-card__logo { width: min(120px, 70%); margin-bottom: ${theme.spacing[8]}; }
  ...
  strong { display: block; margin: ${theme.spacing[4]} 0 ${theme.spacing[12]}; color: ${({ $isDark }) => ($isDark ? theme.colors.white : theme.colors.textPrimary)}; font-size: ${theme.fontSize.h4.size}; line-height: 1; }
