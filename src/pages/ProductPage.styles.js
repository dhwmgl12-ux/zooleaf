...
export const ProductPageContainer = styled.main`
  padding: 0 0 ${theme.spacing[140]};

  .product-page__banner { display: block; margin-top: -${theme.spacing[48]}; margin-bottom: ${theme.spacing[48]}; }
  ...
  @media (max-width: ${theme.layout.breakpoint.tablet}) {
    padding-top: 0;
    .product-page__banner { margin-top: -${theme.spacing[32]}; }
  ...
  @media (max-width: ${theme.layout.breakpoint.mobile}) {
    padding-top: 0;
    .product-page__banner { margin-top: -${theme.spacing[24]}; margin-bottom: ${theme.spacing[24]}; }
